...
opcode_entry opcode_table [512] = {
  ...
  /* 0x48 */	IDEXW(r, dec, 4), IDEXW(r, inc, 4), IDEXW(r, dec, 4), IDEXW(r, dec, 4),
  ...
  /* 0x68 */	IDEXW(I, push, 1), IDEX(I_E2G, imul3), IDEXW(I, push, 1), IDEX(I_E2G, imul3),
  ...
  /* 0x78 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x7c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x80 */	IDEXW(E, jcc, 1), IDEXW(E, jcc, 1), IDEXW(E, jcc, 1), IDEXW(E, jcc, 1),
  /* 0x84 */	IDEXW(E, jcc, 1), IDEXW(E, jcc, 1), IDEXW(E, jcc, 1), IDEXW(E, jcc, 1),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(E2G, movzx), IDEXW(E2G, movzx, 2),
